 ...
 * 2013-09-15T11:56:52.275+02:00
 * Generated source version: 2.7.6
 * 
 */
@WebServiceClient(name = "SimpleService", 
                  wsdlLocation = "file:/C:/zero/REPOS/zero-web-services/SimpleService/src/main/resources/SimpleServiceWrapped.wsdl",
...
public class SimpleService_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/zero/REPOS/zero-web-services/SimpleService/src/main/resources/SimpleServiceWrapped.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(SimpleService_Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/zero/REPOS/zero-web-services/SimpleService/src/main/resources/SimpleServiceWrapped.wsdl");
        }
        WSDL_LOCATION = url;
    }
