...
@WebServiceClient(name = "bizService", 
                  wsdlLocation = "file:/C:/zero/REPOS/zero-web-services/bizServiceClient/src/main/resources/bizService.wsdl",
...
public class BizService_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/zero/REPOS/zero-web-services/bizServiceClient/src/main/resources/bizService.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(BizService_Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/zero/REPOS/zero-web-services/bizServiceClient/src/main/resources/bizService.wsdl");
        }
        WSDL_LOCATION = url;
    }
